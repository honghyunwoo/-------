...
### P0: 스크립트 생성 플레이북 (즉시 작업)

**목적**: 다음 Claude가 "스크립트 10개 더 필요해"라고 하면 즉시 답변 가능하도록

**작업**: `.claude/SCRIPT_PLAYBOOK.md` 생성

**포함 내용**:
1. GPT-5/Opus 4.5용 프롬프트 템플릿 (복사-붙여넣기)
2. 카테고리별 주제 목록 (각 50개)
3. 검증 체크리스트
4. 저장 및 실행 방법

**참조**:
- `templates/script_v2.1_guide.md` - 스크립트 규칙
- `data/scripts_v2.1_examples.json` - 예제 10개
- 계획 파일: `~/.claude/plans/memoized-scribbling-island.md`
